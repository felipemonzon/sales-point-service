...
import com.moontech.salesPoint.infrastructure.property.SwaggerProperties;
...
public class SwaggerConfig {
  ...
  private Info apiInfo() {
    return new Info()
        ...
        .license(
            new License()
                .name(this.swaggerConstants.getLicenceType())
                .url(this.swaggerConstants.getLicenceUrl()));
  }
}
